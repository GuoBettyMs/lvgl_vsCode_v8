...
INC 				:= -I./ui/simulator/inc/ -I./ -I./lvgl/ -I/opt/homebrew/Cellar/sdl2/2.32.6/include #-I/usr/include/freetype2 -L/usr/local/lib
LDLIBS	 			:= -lm -L /opt/homebrew/Cellar/sdl2/2.32.6/lib -l SDL2 #-l$(LV_DRIVER) -lpthread -lm #-lfreetype -lavformat -lavcodec -lavutil -lswscale -lm -lz
BIN 				:= $(BIN_DIR)/demo
